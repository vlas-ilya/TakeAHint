    ...
    <div className="rules">
      <div>
        ...
        <ul>
          ...
          <li>
            Слово, имеющее одинаковый корень с загаданным словом Например, «принцесса» не может быть подсказкой для
            слова «принц».
          </li>
        ...
        <p>
          Примечание. Если все подсказки были удалены, положите карточку с загаданным словом в коробку игры и сразу
          переходите к этапу «Конец хода».
        </p>
        <h2>Догадка</h2>
        <p>
          После удаления всех запрещенных подсказок, у ведущего есть <strong>одна</strong> попытка угадать слово
        </p>
